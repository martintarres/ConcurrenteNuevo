    ...
    public  void dispararTransicion(Integer transicion) {
        try {
            ...
            /*    if (prioridadDespertado) {
                ...
                System.out.print("Voy a mostrar las transiciones sensibilizadas");
                VectorSensibilizados.imprimir();
...
//                    log.registrarBasico2(this, VectorSensibilizados, VectorEncolados);
                    System.out.println("voy a mostrar vectores encolados ");
                    VectorEncolados.imprimir();
                   VectorAnd.and(VectorSensibilizados, VectorEncolados);
                   System.out.println("Voy a mostrar el resultado de and");
                   VectorAnd.imprimir();
